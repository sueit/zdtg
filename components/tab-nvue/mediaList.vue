<template>
<view>
    <view class="list-cell" hover-class="uni-list-cell-hover" @click="bindClick" style="margin:20px;background:#fff">
        <view class="media-list" v-if="options.title">
            ...
            <view class="uni-triplex-row" style="padding: 18px 11px 5px 15px;">
            ...
            <view class="progress-box" style="padding:0 15px">
                <progress percent="80" show-info activeColor="#57bce8" backgroundColor="#e5e6ea" active stroke-width="10" />
            </view>

            <view class="uni-triplex-row" style="padding: 5px 11px 5px 15px;">
                <view class="uni-triplex-left" style="width:100%">
            ...
            <view class="uni-triplex-row" style="padding: 25px 15px 25px 15px;">
                <view class="uni-triplex-left" style="width:100%">
